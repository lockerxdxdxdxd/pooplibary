--[[ Credits
    ...
    kors - skidding to add changable ui keybind and other stuff
]]
-- // Variables
...
local keybindtoggle = Enum.KeyCode.Z
-- UI Variables
local library = {
    drawings = {},
    hidden = {},
...
do
    ...
    function library:New(info)
        ...
        theme.accent = accent
        --Enum.
        local window = {pages = {}, isVisible = false, uibind = keybindtoggle, currentPage = nil, fading = false, dragging = false, drag = Vector2.new(0,0), currentContent = {frame = nil, dropdown = nil, multibox = nil, colorpicker = nil, keybind = nil}}
        --
